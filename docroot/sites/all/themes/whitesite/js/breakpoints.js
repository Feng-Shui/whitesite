...
(function ($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.whitesiteBreakpoints = {
    ...
    attach: function(context, settings) {
      ...
      $(window).resize(function () {
        Drupal.behaviors.whitesiteBreakpoints.refreshValue();
      });
    ...
    refreshValue: function () {
      Drupal.settings.whitesite.breakpoint = window.getComputedStyle(document.querySelector('body'), ':before').getPropertyValue('content').replace(/\"/g, '');
      this.refreshClass();
    },
    ...
    refreshClass: function () {
      ...
      }).addClass('breakpoint-' + Drupal.settings.whitesite.breakpoint);
    }
