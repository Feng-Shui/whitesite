 ...
 */
function whitesite_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function whitesite_preprocess_node(&$variables) {
 ...
 */
function whitesite_preprocess_maintenance_page(&$variables) {
  $variables['header'] = _whitesite_preprocess_region_header();
}

/**
 * Implements THEME_preprocess_block().
 */
function whitesite_preprocess_block(&$variables) {
 ...
 */
function whitesite_preprocess_region(&$variables) {
 ...
 */
function whitesite_breadcrumb($variables) {
 ...
 */
function whitesite_menu_local_tasks($variables) {
  $output = '';
  ...
  // Process tabs.
  $output = _whitesite_process_local_tasks($output);
 ...
 */
function whitesite_link($variables) {
  // Check link classes.
  if (isset($variables['options']['attributes']['class'])) {
    ...
    $variables['options']['attributes']['class'] = _whitesite_active_link($class_pairs, $classes);
  }
 ...
 */
function whitesite_pager($variables) {
  $tags = $variables['tags'];
 ...
 */
function whitesite_status_messages($variables) {
 ...
 */
function whitesite_form_element_label($variables) {
  $element = $variables['element'];
 ...
 */
function whitesite_form_element($variables) {
  $element = &$variables['element'];
 ...
 */
function whitesite_fieldset($variables) {
  $element = $variables['element'];
 ...
 */
function whitesite_toc_filter($variables) {
  $output = '';
 ...
 */
function whitesite_toc_filter_back_to_top($variables) {
 ...
 */
function _whitesite_process_local_tasks($children) {
 ...
 *
 * @see whitesite_preprocess_page().
 */
function _whitesite_preprocess_region_header($header_content = '') {
 ...
 *   Class array.
 */
function _whitesite_active_link($class_pairs, $classes) {
 ...
 *   The panel markup
 */
function _whitesite_render_panel_layout($variables) {
  ...
  $output  = '';
  $output .= '<div' . drupal_attributes($attributes) . '>';
  $output .= _whitesite_render_panel_layout_build_grid($variables['layout']['grid'], $variables['content']);
  $output .= '</div>';
 ...
 *
 * @see _whitesite_render_panel_layout().
 *
 * @param array $grid
 *
 * @param array $content
 ...
 * @return string
 */
function _whitesite_render_panel_layout_build_grid($grid, $content) {
  $output  = '';
  ...
  foreach ($grid as $row => $columns) {
    ...
    foreach ($columns as $key => $data) {
      ...
      if (is_array($data)) {
        ...
        $output .= _whitesite_render_panel_layout_build_grid($data['children'], $content);
        $output .= '</div>';
      }
 ...
 */
function _whitesite_prepare_panel_layout_array($human_name, $machine_name, $rows_cols, $category = null) {
  if (empty($category)) {
    $category = t('UI Kit');
  }
  ...
  $data = _whitesite_prepare_panel_layout_array_extract_layout($rows_cols);
 ...
 * declaration.
 *
 * @see _whitesite_prepare_panel_layout_array().
 *
 * @param array $rows_cols
 ...
 */
function _whitesite_prepare_panel_layout_array_extract_layout($rows_cols) {
  ...
  foreach ($rows_cols as $delta => $row) {
    ...
    foreach ($row as $key => $data) {
      ...
      if (!empty($data['children'])) {
        $returned = _whitesite_prepare_panel_layout_array_extract_layout($data['children']);
 ...
 * @param array $variables
 *
 * @see whitesite_preprocess_html().
 */
function _whitesite_full_width_styling(&$variables) {
